      ...
      <div style={{ width: "100%", maxWidth: 640, display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{
          ...
          <ul style={ulStyle}>
            ...
            <li>改善服務品質與修復錯誤</li>
            <li>若您違反使用條款，我們可能記錄您的帳號資訊（電子信箱）以限制您後續使用本服務的權限</li>
          </ul>
          ...
          <ul style={ulStyle}>
            ...
            <li><strong>帳號限制紀錄</strong>：若您的帳號因違反使用條款遭限制使用權限，我們會保留您的電子信箱於限制名單中，即使您嘗試刪除帳號或使用相同電子信箱重新註冊，此限制紀錄不會因此失效；此紀錄與您原有的比賽紀錄、段位等個人資料為各自獨立之機制</li>
          </ul>
